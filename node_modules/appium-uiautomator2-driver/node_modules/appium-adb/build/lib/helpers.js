...
exports.getResourcePath = exports.DEFAULT_ADB_EXEC_TIMEOUT = exports.APK_EXTENSION = exports.APKS_INSTALL_TIMEOUT = exports.APK_INSTALL_TIMEOUT = exports.APKS_EXTENSION = exports.extractMatchingPermissions = exports.getOpenSslForOs = exports.getBuildToolsDirs = exports.getSdkToolsVersion = exports.getJavaHome = exports.getJavaForOs = void 0;
...
async function readPackageManifest(apkPath) {
    ...
    logger_js_1.default.debug(`Reading package manifest: '${support_1.util.quote([aapt2Binary, ...args])}'`);
    /** @type {string} */
    let stdout;
    try {
