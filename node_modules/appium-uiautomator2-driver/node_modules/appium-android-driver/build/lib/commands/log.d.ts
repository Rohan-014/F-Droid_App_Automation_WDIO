...
export namespace supportedLogTypes {
    ...
    namespace bugreport {
        ...
        export function getter_1(self: import("../driver").AndroidDriver): Promise<import("appium-adb").LogcatRecord[]>;
        export { getter_1 as getter };
    }
    namespace server {
        let description_2: string;
        export { description_2 as description };
        export function getter_2(self: import("../driver").AndroidDriver): import("appium-adb").LogcatRecord[];
